...
const ProfileOwner = () => {
  ...
  const handelCancelYes = async () => {
    ...
    try {
      setLaod(true);
      await fetch(
        `https://a7gezlyapi.azurewebsites.net/api/Owner/${users.id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      try {
        ...
        let url = `https://a7gezlyapi.azurewebsites.net/api/Owner/Add Profile Picture?id=${users.id}`;
      ...
      <div className="l_form">
        <div className="container">
          <div className="lo_form">
            ...
            {users.position ? (
              <div className="user_data">{users.position}</div>
            ) : null}
            ...
            <div className="profile_link">
              ...
              <div className="profile_change_pass">
                <NavLink to={"/owneredit"}>Edit</NavLink>
                <NavLink to={"/changeownerpass"}>Change Password</NavLink>
              </div>
            </div>
