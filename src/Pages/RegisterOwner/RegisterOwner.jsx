...
import { BaseSchemaowner } from "../../Components/schemas/Schema";
...
const RegisterOwner = () => {
  ...
  const { values, errors, touched, handleChange, handleBlur, handleSubmit } =
    useFormik({
      ...
      validationSchema: BaseSchemaowner,
      onSubmit,
    });

  return (
    <div className="r_owner">
      <Navbar login={"createAcc"} home={"home"} stadiums={"stadium"} />
      {load ? <Loading /> : null}
      <img src={back} alt="" className="r_owner_img" />
            ...
            <div className="f_one">
              <div className="r_tags content">
                ...
                <span className="register_as active">
                  <NavLink to={"/register"}>Owner</NavLink>
                </span>
              </div>
